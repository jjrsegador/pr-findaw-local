...
import { ObservableDetalleService } from 'src/app/servicios/observable-detalle.service';
...
export class CuerpoComponent implements OnInit {
    ...
    constructor (private listarcontactosService : ListarcontactosService,
                 private observableDetalle : ObservableDetalleService) {
    }
    ...
    emitirContactoDetalle(icontacto:Contacto){

        this.observableDetalle.emitirContacto(icontacto);

        console.log("emitirContactoDetalle - nombre: "+ icontacto.nombre );
        console.log("emitirContactoDetalle - fecha: " + icontacto.fechaCreacion);
    }
}
